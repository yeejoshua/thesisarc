<?php
    ...
    $sql = "SELECT title, author, adviser, college, course, date,content, id FROM theses WHERE course = 'BS Management Accounting'";
    ...
    <div class="content">
        <div class="row">
            <div class="column middle">
                <h2>BS Management Accounting</h2>
                <section class="index-category">
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "No theses found for the course 'BS Management Accounting'.";
                        }
                    ?>
                </section>
            </div>
