<?php
    ...
    $sql = "SELECT title, author, adviser, college, course, date,content, id FROM theses WHERE course = 'BS Environmental Science and Sustainability'";
    ...
    <div class="content">
        <div class="row">
            <div class="column middle">
                <h2>BS Environmental Science and Sustainability</h2>
                <section class="index-category">
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "No theses found for the course 'BS Environmental Science and Sustainability'.";
                        }
                    ?>
                </section>
            </div>
