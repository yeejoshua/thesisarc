<?php
    ...
    $sql = "SELECT title, author, adviser, college, course, date,content, id FROM theses WHERE course = 'BS International Tourism Management'";
    ...
    <div class="content">
        <div class="row">
            <div class="column middle">
                <h2>BS International Tourism Management</h2>
                <section class="index-category">
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "No theses found for the course 'BS International Tourism Management'.";
                        }
                    ?>
                </section>
            </div>
