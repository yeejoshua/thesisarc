<?php
    ...
    $sql = "SELECT title, author, adviser, college, course, date,content, id FROM theses WHERE course = 'AB Multimedia Arts'";
                ...
                <section class="index-category">
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "No theses found for the course 'AB Multimedia Arts'.";
                        }
                    ?>
                </section>
            </div>
