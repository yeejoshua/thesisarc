<?php
    ...
    $sql = "SELECT title, author, adviser, college, course, date,content, id FROM theses WHERE course = 'BS Customs Administration'";
    ...
    <div class="content">
        <div class="row">
            <div class="column middle">
                <h2>BS Customs Administration</h2>
                <section class="index-category">
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "No theses found for the course 'BS Customs Administration'.";
                        }
                    ?>
                </section>
            </div>
