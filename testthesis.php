        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="advancedsearch.php">Advanced Search</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <form action="" method="GET">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <input type="number" name="from_year" value="<?= isset($_GET['from_year']) ? htmlspecialchars($_GET['from_year']) : '' ?>" class="form-control" placeholder="From Year">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <input type="number" name="to_year" value="<?= isset($_GET['to_year']) ? htmlspecialchars($_GET['to_year']) : '' ?>" class="form-control" placeholder="To Year">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <select name="college" class="form-select">
                                                ...
                                                <option value="cir" <?= (isset($_GET['college']) && $_GET['college'] == 'cir') ? 'selected' : '' ?>>College of Internal Relations</option>
                                                <option value="cithm" <?= (isset($_GET['college']) && $_GET['college'] == 'cithm') ? 'selected' : '' ?>>College of Internal Tourism and Hospitality Management</option>
                                        ...
                                        <div class="col-md-12 text-end">
                                            ...
                                            <a href="advancedsearch.php" class="btn btn-danger">Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
